...
import { getTrait } from "../../process/traits/trait-manager";
...
export function TraitDrawerContent(props: {
    ...
    const trait = getTrait<Trait>('CHARACTER', props.data.variableName)
    const timeline: any[] = []
